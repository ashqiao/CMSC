   ...
   public void printArray( )
   {
    for ( int row = 0; row < intArray.length; row++ )
    {
      for ( int column = 0; column < intArray[row].length; column++ )
      {
        ...
        animate( row, column );  // animate current element
      }
      System.out.println( );
    }
   }
   ...
   */
   public void setValues( int value, int row )
   {
    for ( int column = 0; column < intArray[row].length; column++ )
    {
      ...
      animate( row, column );  // animates updated elment
    }
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    for ( int row = 0; row < intArray.length; row++ )
    {
      ...
      animate( row, column, minimum );  // animates comparison
    }
    return minimum;
   }
   ...
   public int countFound( int value )
   {
    ...
    for ( int row = 0; row < intArray.length; row++ )
    {
      for ( int column = 0; column < intArray[row].length; column++ )
      {
        ...
        animate( row, column, num );  // animate frequency count
      }
    }
    return num;
   }
